...
void BotPulse() {
    ...
    if (g_Active) {
        ...
        // Foolproof поиск локального игрока через GUID из менеджера
        ...
        // Задержка в 500мс, чтобы не спамить движок вызовами каждый кадр
...
// Голый хук главного потока. Максимально безопасно.
...
DWORD WINAPI Setup(LPVOID) {
    ...
    printf("[+] Bot v117: Main Thread + Foolproof Engine.\n");
